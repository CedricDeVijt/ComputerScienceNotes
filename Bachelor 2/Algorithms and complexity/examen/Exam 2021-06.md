...
### (b) (2.5pt) We hebben gezien dat $PATH = \{〈G, s, t〉| \text{ er is een pad van s naar t in de gerichte graaf G}\}$ een probleem is in NLOGSPACE. Beschrijf het NLOGSPACE algoritme voor PATH in pseudo-code en analyseer dat het inderdaad een NLOGSPACE algoritme is.
